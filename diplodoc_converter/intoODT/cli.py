...
def main():
    ...
    parser.add_argument("-i", "--input-dir", required=True, help="Корневая папка документации")
    parser.add_argument("-o", "--output", required=True, help="Выходной ODT-файл")
    parser.add_argument("--reference", default=None, help="ODT-файл с пользовательскими стилями")
    parser.add_argument("--width-threshold", type=int, default=700, help="Ширина для масштабирования")
    parser.add_argument("--max-heading", type=int, default=6, help="Макс. уровень заголовка")
    parser.add_argument("--caption-position", choices=["below", "inside"], default="inside", help="Расположение подписи: below – под картинкой, inside – внутри alt")
